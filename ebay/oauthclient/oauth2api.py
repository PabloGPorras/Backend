...
class oauth2api(object):
    ...
    def generate_user_authorization_url(self,credentialutil_inst, env_type, scopes, state=None):
        '''
    ...
    def get_application_token(self,credentialutil_inst, env_type, scopes):
        """
    ...
    def exchange_code_for_access_token(self,credentialutil_inst, env_type, code):       
        ...
        _________________________
        env_type.api_endpoint: {env_type.api_endpoint}
        _________________________
        headers: {headers}
        _________________________
        body: {body}
